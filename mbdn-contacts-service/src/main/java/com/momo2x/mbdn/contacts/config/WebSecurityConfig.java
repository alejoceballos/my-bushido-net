package com.momo2x.mbdn.contacts.config;

import com.momo2x.mbdn.contacts.security.ContactAuthenticationEntryPoint;
...
public class WebSecurityConfig {
    ...
    private final ContactAuthenticationEntryPoint authenticationEntryPoint;
